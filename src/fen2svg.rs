pub fn fen2svg(fen: String, flipped: bool) -> String {
    ...
    for row in fen.split("/") {
        let mut x: usize = 0;
        for c in row.chars() {
            let (xx, yy) = if flipped {
                (GRID_SIZE * 7 - x, GRID_SIZE * 7 - y)
            } else {
                (x, y)
            };
            match c {
...
const BOARD : &str= r##"<path d="M0 0l45 0l0 360l45 0l0 -360l45 0l0 360l45 0l0 -360l45 0l0 360l45 0l0 -360l45 0l0 360l45 0l0 -45l-360 0l0 -45l360 0l0 -45l-360 0l0 -45l360 0l0 -45l-360 0l0 -45l360 0l0 -45l-360 0l0 -45" fill="#f3f3f3" opacity="0.6" stroke="none"/>"##;
