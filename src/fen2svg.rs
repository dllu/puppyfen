pub fn fen2svg(fen: String) -> String {
    let mut svg: String = "".to_string();
    svg.push_str(SVG_HEAD);
    svg.push_str(BOARD);
    let mut y: usize = 0;
    ...
    svg.push_str(SVG_TAIL);
    svg
}

const BOARD : &str= r##"<path d="M0 0l45 0l0 360l45 0l0 -360l45 0l0 360l45 0l0 -360l45 0l0 360l45 0l0 -360l45 0l0 360l45 0l0 -45l-360 0l0 -45l360 0l0 -45l-360 0l0 -45l360 0l0 -45l-360 0l0 -45l360 0l0 -45l-360 0l0 -45" fill="#f3f3f3" stroke="none"/>"##;
...
const SVG_HEAD : &str = r##"<svg xmlns="http://www.w3.org/2000/svg" width="360" height="360"><rect width="360" height="360" fill="#75a"/><g fill="none" fill-rule="evenodd" stroke="#000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">"##;
const SVG_TAIL: &str = r##"</g></svg>"##;
